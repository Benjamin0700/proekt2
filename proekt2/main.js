let obj = [
    {
        ...
        image: "image-removebg-preview (14).png",
        rating: {
            rate: 3.9,
            count: 120
        }
    },
    {
        ...
        category: "men's clothing",
        image: "image-removebg-preview (8).png",
        rating: {
            rate: 4.1,
            count: 259
        }
    ...
    },
    {
        ...
        category: "men's clothing",
        image: "image-removebg-preview (12).png",
        rating: {
            rate: 2.1,
            count: 430
        }
    ...
    },
    {
        ...
        category: "jewelery",
        image: "image-removebg-preview (4).png",
        rating: {
            rate: 3.9,
            count: 70
        }
...
obj.forEach(workers => { 
    ...
    h1.textContent = workers.title 
    p.textContent = workers.price 
    p2.textContent = workers.description 
    p3.textContent = workers.category 
    img.src = workers.image 

    box.classList.add('box')

    box.style.border = `5px solid #B67352` 
    box.style.textAlign = `center` 
    box.style.color = `#FFF5E4` 
    box.style.backgroundColor = `#DCA47C` 
